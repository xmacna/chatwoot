...
ActiveRecord::Schema[7.1].define(version: 2026_08_13_053000) do
  ...
  create_table "messages", id: :serial, force: :cascade do |t|
    ...
    t.index ["account_id", "inbox_id", "source_id"], name: "index_messages_on_api_incoming_waid", where: "((message_type = 0) AND (source_id ~~ 'WAID:%'::text))"
